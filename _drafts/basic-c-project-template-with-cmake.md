...
After hunting for a week or two (yes, I am a indecisive programmer, with a bit of procrastination as well), I settled down with \[clang\]([https://clang.llvm.org](https://clang.llvm.org "https://clang.llvm.org")) as my compiler, \[CMake\]([https://cmake.org](https://cmake.org "https://cmake.org")) as the build files generator, and \[ninja\]([https://ninja-build.org](https://ninja-build.org "https://ninja-build.org")) as the build system. Also, not to forget about unit testing, I used \[Google Test\]([https://github.com/google/googletest](https://github.com/google/googletest "https://github.com/google/googletest")).
...
While setting up a C++ project of mine, I noticed that there will be a fixed structure of directory I could reuse, hence, I created this repository in Github, served as the basic template for my future project. It is known as \[hongping/cpp_template\]([https://github.com/hongping/cpp_template](https://github.com/hongping/cpp_template "https://github.com/hongping/cpp_template")) in Github.
...
Feel free to clone \[hongping/cpp_template\]([https://github.com/hongping/cpp_template](https://github.com/hongping/cpp_template "https://github.com/hongping/cpp_template")) and use this for your future project!